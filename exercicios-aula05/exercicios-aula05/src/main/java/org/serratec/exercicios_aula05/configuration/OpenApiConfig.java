package org.serratec.exercicios_aula05.configuration;
...
public class OpenApiConfig {
	...
	OpenAPI myOpenAPI() {
		...
		prodServer.setUrl("https://api.meudominio.com.br");
		...
		Info info = new Info().title("API de testes").version("1.0").contact(contact)
				.description("API para gerenciamento de funcionários").termsOfService("https://www.meudominio.com.br/termos")
